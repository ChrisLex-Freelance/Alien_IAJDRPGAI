...
## INTRODUCTION
Cet article/projet est un regroupement de différent éléments de contextes pour le Jeu de Rôle Alien. Certain passage sont issu d'articles que j'ai écrit pour un blog.
...
### [GUIDE DE CREATION D'UNE CORPORATION](https://github.com/ChrisLex-Freelance/Alien_IAJDRPGAI/main/CORPORATION_GUIDE_DE_CREATION.md#guide-de-creation-dune-corporation)
...
| D66   | ÉVÉNEMENTS                                                                                                                                                                                  |
|------ |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 11–13 | Vous avez calmé une émeute sur une station avec une chanson. **Gagnez le talent PRÉSENCE APAISANTE.**                                                                                       |
| 14–16 | Vous avez tourné une scène culte sur une colonie. Depuis, tout le monde vous reconnaît. **+1 en MANIPULATION.**                                                                             |
| 21–24 | Vous avez été enfermé pour "nuisance culturelle". Vous en êtes sorti en un seul morceau. **Gagnez le talent ESPRIT DE CONTRADICTION.**                                                      |
| 25–31 | Vous avez animé les derniers instants d'un vaisseau condamné. **+1 en COMMANDEMENT.**                                                                                                       |
| 32–34 | Vous avez réussi à faire rire un commandant en pleine alerte rouge. **Gagnez le talent DEUXIÈME SOUFFLE.**                                                                                  |
| 35–41 | Vous avez trahi un public... pour mieux le reconquérir. **Gagnez le talent RUSE.**                                                                                                          |
| 42–44 | Vous avez aidé à manipuler un système d'intercom pour diffuser un message crypté. **+1 en COMTECH.**                                                                                        |
| 45–52 | Vous avez assuré un spectacle en apesanteur. **+1 en MOBILITÉ.**                                                                                                                            |
| 53–55 | Vous avez improvisé une scène de théâtre dans une salle de soins. Cela a redonné espoir. **+1 en SOINS MÉDICAUX.**                                                                          |
| 56–62 | Vous avez calmé un enfant traumatisé avec une histoire inventée. **Gagnez le talent VIGILANT.**                                                                                             |
| 63–66 | Vous avez joué pendant des heures pour couvrir les bruits d'une créature dans les murs. **Gagnez le talent CALME OLYMPIEN.**                                                                |

#### AGENT DE LA COMPAGNIE

| D66   | ÉVÉNEMENTS                                                                                                                                                                                  |
|------ |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 11–13 | Vous avez négocié une fusion entre deux filiales rivales. Tout le monde y a perdu sauf vous. **Vous gagnez le talent IMPITOYABLE.**                                                         |
| 14–16 | Une IA de supervision a failli provoquer une purge automatique. Vous avez stoppé le processus. **Vous gagnez +1 dans la compétence COMTECH.**                                               |
| 21–24 | Vous avez étouffé un scandale impliquant un haut cadre. Depuis, vous avez un dossier sur tout le monde. **Vous gagnez le talent RUSE.**                                                     |
| 25–31 | Lors d’une évacuation de station, vous avez sélectionné qui avait le droit de vivre. **Vous gagnez le talent MOI D’ABORD.**                                                                 |
| 32–34 | Vous avez été pris dans une embuscade. Vous avez survécu sans tirer une seule balle. **Vous gagnez +1 dans la compétence SURVIE.**                                                          |
| 35–41 | Vous avez persuadé un chef de colonie de vous remettre ses archives privées. Il ne s’en est jamais remis. **Vous gagnez +1 dans la compétence MANIPULATION.**                               |
| 42–44 | On vous a confié la direction d’un avant-poste. Malgré les tensions, vous avez gardé le contrôle. **Vous gagnez +1 dans la compétence COMMANDEMENT.**                                       |
| 45–52 | Vous avez falsifié des rapports d’audit techniques, évitant un rappel de produit coûteux. **Vous gagnez +1 dans la compétence COMTECH.**                                                    |
| 53–55 | Vous avez participé à une opération de récupération d’objet classé. Vous avez gardé un échantillon. **Vous gagnez le talent RÉSERVE CACHÉE.**                                               |
| 56–62 | Un employé a menacé de tout révéler. Vous avez retourné ses accusations contre lui. **Vous gagnez le talent ESPRIT DE CONTRADICTION.**                                                      |
| 63–66 | Après la disparition d’un cadre, vous avez assuré la transition sans heurts. **Vous gagnez le talent DÉUXIÈME SOUFFLE.**                                                                    |
...
| D66   | ÉVÉNEMENTS                                                                                                                                                                                  |
|------ |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 11–13 | Vous avez grandi dans les conduits de maintenance, invisible aux yeux des adultes. **Vous gagnez le talent FURTIF.**                                                                        |
| 14–16 | Un jour, vous avez arrêté un sas avant qu’il ne s’ouvre dans le vide. **Vous gagnez +1 dans la compétence COMTECH.**                                                                        |
| 21–24 | Vous avez volé un rationnaire sous les yeux d’un marine. Il ne vous a jamais vu. **Vous gagnez +1 dans la compétence MOBILITÉ.**                                                            |
| 25–31 | Vous avez traversé un pont d’accès sous une tempête d’acide. Personne ne pensait que c’était possible. **Vous gagnez le talent ROBUSTE.**                                                   |
| 32–34 | Vous avez vu un adulte mourir sous vos yeux. Vous avez gardé le silence. **Vous gagnez le talent CALME OLYMPIEN.**                                                                          |
| 35–41 | Une vieille androïde vous a appris à reconnaître les systèmes de sécurité. **Vous gagnez +1 dans la compétence OBSERVATION.**                                                               |
| 42–44 | Vous avez construit un leurre fonctionnel avec des débris. **Vous gagnez le talent BIDOUILLAGE.**                                                                                           |
| 45–52 | Vous avez traversé une section dépressurisée en retenant votre souffle. **Vous gagnez le talent SOUFFLE CALME.**                                                                            |
| 53–55 | Une escouade s’est perdue dans les niveaux inférieurs. C’est vous qui les avez guidés vers la sortie. **Vous gagnez +1 dans la compétence COMMANDEMENT.**                                   |
| 56–62 | Vous avez été pris dans une explosion. Depuis, vous boitez un peu, mais vous êtes coriace. **Vous gagnez +1 dans la compétence ENDURANCE.**                                                 |
| 63–66 | Un scientifique vous a fait confiance. Vous l’avez aidé à manipuler du matériel sensible. **Vous gagnez le talent SPÉCIALISTE EXTRAVÉHICULAIRE.**                                           |

MARSHAL COLONIAL

| D66  | ÉVÉNEMENTS                                                                                                                                                                                   |
|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 11–13 | Vous avez désamorcé un conflit armé entre colons sans tirer un coup de feu. **Vous gagnez le talent DÉUXIÈME SOUFFLE.**                                                                     |
| 14–16 | Vous avez dû abattre un suspect sous stéroïdes. L’enquête vous a donné raison. **Vous gagnez +1 dans la compétence COMBAT RAPPROCHÉ.**                                                      |
| 21–24 | Vous avez retrouvé un enfant disparu dans les conduits d’une station. **Vous gagnez +1 dans la compétence OBSERVATION.**                                                                    |
| 25–31 | Vous avez été piégé dans un poste de sécurité isolé par un groupe hostile. Vous avez tenu bon. **Vous gagnez le talent NERFS D’ACIER.**                                                     |
| 32–34 | Vous avez découvert un trafic d’organes géré par un sous-traitant de la Compagnie. Vous avez effacé les preuves. **Vous gagnez le talent RUSE.**                                            |
| 35–41 | Vous avez calmé une foule paniquée en pleine quarantaine. **Vous gagnez +1 dans la compétence COMMANDEMENT.**                                                                               |
| 42–44 | Vous avez identifié un tueur à partir de traces quasi invisibles. **Vous gagnez le talent VIGILANT.**                                                                                       |
| 45–52 | Vous avez été blessé en service, mais avez continué à protéger les civils. **Vous gagnez +1 dans la compétence ENDURANCE.**                                                                 |
| 53–55 | Vous avez assisté à l’évasion d’un prisonnier… que vous avez laissé filer. **Vous gagnez le talent CALME OLYMPIEN.**                                                                        |
| 56–62 | Vous avez interpellé un androïde sans déclencher sa défense automatique. **Vous gagnez +1 dans la compétence MANIPULATION.**                                                                |
| 63–66 | Lors d’une mission d’extraction, vous avez guidé tout un groupe vers la sortie malgré l’effondrement d’une structure. **Vous gagnez le talent GARDE DU CORPS.**                             |

#### MARINES COLONIAL

| D66  | ÉVÉNEMENTS                                                                                                                                                                                   |
|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 11–13 | Vous avez nettoyé un nid inconnu avec votre escouade. Vous étiez le seul à en sortir vivant. **Vous gagnez le talent NERFS D’ACIER.**                                                       |
| 14–16 | Vous avez maintenu votre position pendant 36 heures sous feu ennemi. **Vous gagnez +1 dans la compétence ENDURANCE.**                                                                       |
| 21–24 | Une embuscade a détruit votre peloton. Vous avez fait tomber l’ennemi par derrière. **Vous gagnez +1 dans la compétence MOBILITÉ.**                                                         |
| 25–31 | Vous avez combattu en zéro-G sans formation. Vous avez improvisé. **Vous gagnez le talent ENTRAÎNEMENT GRAVITÉ ZÉRO.**                                                                      |
| 32–34 | Vous avez abattu une cible à 800 mètres avec un fusil standard. **Vous gagnez +1 dans la compétence COMBAT À DISTANCE.**                                                                    |
| 35–41 | Vous avez combattu un adversaire plus fort à mains nues. Vous avez gagné. **Vous gagnez +1 dans la compétence COMBAT RAPPROCHÉ.**                                                           |
| 42–44 | Votre armure a été percée. Vous avez terminé la mission avec un harnais et une seringue d’adré. **Vous gagnez le talent ROBUSTE.**                                                          |
| 45–52 | Vous avez dirigé votre escouade hors d’un piège. On vous appelle "Sergent Miracle". **Vous gagnez +1 dans la compétence COMMANDEMENT.**                                                     |
| 53–55 | Vous avez survécu trois jours seul derrière les lignes ennemies. **Vous gagnez +1 dans la compétence SURVIE.**                                                                              |
| 56–62 | Vous avez été touché, mais avez gardé votre sang-froid pour couvrir la retraite. **Vous gagnez le talent DÉUXIÈME SOUFFLE.**                                                                |
| 63–66 | Vous avez lancé une charge avec un véhicule blindé sous feu nourri. **Vous gagnez le talent SPÉCIALISTE DES ARMES.**                                                                        |

#### MERCENAIRE

| D66  | ÉVÉNEMENTS                                                                                                                                                                                   |
|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 11–13 | Vous avez mené une mission pour la Compagnie… sans poser de questions. **Vous gagnez le talent IMPITOYABLE.**                                                                               |
| 14–16 | Vous avez sauvé un client d’un piège explosif en le traînant à couvert. **Vous gagnez +1 dans la compétence MOBILITÉ.**                                                                     |
| 21–24 | Un contact vous a trahi. Vous avez survécu et appris à ne faire confiance à personne. **Vous gagnez le talent ESPRIT DE CONTRADICTION.**                                                    |
| 25–31 | Vous avez piraté un sas pour sortir d’un vaisseau contaminé. **Vous gagnez +1 dans la compétence COMTECH.**                                                                                 |
| 32–34 | Un contrat vous a forcé à négocier la libération d’un otage sans arme. **Vous gagnez +1 dans la compétence MANIPULATION.**                                                                  |
| 35–41 | Vous avez dû improviser une défense avec des outils de chantier. **Vous gagnez le talent BIDOUILLAGE.**                                                                                     |
| 42–44 | Vous avez été pris pour cible par un drone automatique. Vous avez réussi à le désactiver sans alerter personne. **Vous gagnez le talent FURTIF.**                                           |
| 45–52 | Vous avez pris le contrôle d’un vaisseau après la mort du pilote. **Vous gagnez +1 dans la compétence PILOTAGE.**                                                                           |
| 53–55 | Vous avez laissé tomber un employeur. Il ne vous a jamais retrouvé. **Vous gagnez le talent RÉSERVE CACHÉE.**                                                                               |
| 56–62 | Vous avez abattu une créature inconnue avec une simple arme de poing. **Vous gagnez +1 dans la compétence COMBAT À DISTANCE.**                                                              |
| 63–66 | Vous avez protégé un groupe de civils jusqu’à l’évacuation sous le feu. **Vous gagnez le talent GARDE DU CORPS.**                                                                           |

#### OFFICIER

| D66  | ÉVÉNEMENTS                                                                                                                                                                                   |
|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 11–13 | Lors d’une évacuation chaotique, vous avez maintenu l’ordre et sauvé l’équipage. **Vous gagnez +1 dans la compétence COMMANDEMENT.**                                                        |
| 14–16 | Vous avez désobéi à un ordre inhumain pour protéger vos subordonnés. **Vous gagnez le talent ESPRIT DE CONTRADICTION.**                                                                     |
| 21–24 | En mission, vous avez dû sacrifier un poste pour sauver l’ensemble. **Vous gagnez +1 dans la compétence SURVIE.**                                                                           |
| 25–31 | Une mutinerie a éclaté à bord. Vous avez rétabli l’ordre sans tirer un coup de feu. **Vous gagnez le talent CALME OLYMPIEN.**                                                               |
| 32–34 | Vous avez dirigé une opération de sécurisation en territoire inconnu. **Vous gagnez +1 dans la compétence OBSERVATION.**                                                                    |
| 35–41 | Vous avez été accusé à tort. Vous avez survécu à l'enquête sans trahir vos principes. **Vous gagnez le talent RUSE.**                                                                       |
| 42–44 | Vous avez transformé un groupe de recrues paniquées en une escouade disciplinée. **Vous gagnez +1 dans la compétence MANIPULATION.**                                                        |
| 45–52 | Vous avez dirigé un convoi de ravitaillement sous menace constante. **Vous gagnez +1 dans la compétence PILOTAGE.**                                                                         |
| 53–55 | En zone contaminée, vous avez improvisé un protocole d’évacuation. **Vous gagnez le talent MÉCANO DE VAISSEAU (appliqué au commandement technique).**                                       |
| 56–62 | Vous avez maintenu le moral de l’équipage en promettant un retour… que vous n’avez jamais pu garantir. **Vous gagnez le talent DEUXIÈME SOUFFLE.**                                          |
| 63–66 | Lors d’un exercice simulé qui a dégénéré, vous avez agi comme si c’était réel… ce qui a sauvé tout le monde. **Vous gagnez le talent GARDE DU CORPS.**                                      |
...
| D66  | ÉVÉNEMENTS                                                                                                                                                                                   |
|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 11–13 | Vous avez fait atterrir un vaisseau en feu dans une tempête magnétique. **Vous gagnez +1 dans la compétence PILOTAGE.**                                                                     |
| 14–16 | Vous avez traversé un champ de débris à l’aveugle en suivant votre instinct. **Vous gagnez le talent VIF COMME L’ÉCLAIR.**                                                                  |
| 21–24 | Votre copilote est mort pendant l’approche finale. Vous avez posé l’appareil seul. **Vous gagnez le talent DÉUXIÈME SOUFFLE.**                                                              |
| 25–31 | Vous avez navigué dans une zone de guerre sans être repéré. **Vous gagnez +1 dans la compétence MOBILITÉ.**                                                                                 |
| 32–34 | Vous avez désamorcé un conflit à bord grâce à votre calme en pleine manœuvre. **Vous gagnez le talent CALME OLYMPIEN.**                                                                     |
| 35–41 | Une anomalie gravitationnelle vous a forcé à reprogrammer manuellement les vecteurs. **Vous gagnez +1 dans la compétence COMTECH.**                                                         |
| 42–44 | Vous avez improvisé une évasion avec une navette à moitié alimentée. **Vous gagnez le talent RUSE.**                                                                                        |
| 45–52 | Vous avez fait un saut FTL sans coordonnées valides... et vous avez survécu. **Vous gagnez le talent ROBUSTE.**                                                                             |
| 53–55 | Vous avez utilisé un vaisseau comme leurre dans une opération d’évasion. **Vous gagnez +1 dans la compétence MANIPULATION.**                                                                |
| 56–62 | Vous avez guidé des évacuations sous le feu, plusieurs fois. **Vous gagnez +1 dans la compétence COMMANDEMENT.**                                                                            |
| 63–66 | Vous avez effectué une insertion en chute orbitale sans assistance automatisée. **Vous gagnez le talent ENTRAÎNEMENT GRAVITÉ ZÉRO.**                                                        |

#### PROLO

| D66  | ÉVÉNEMENTS                                                                                                                                                                                   |
|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 11–13 | Vous avez réparé un réacteur de fortune avec des outils rouillés. **Vous gagnez le talent MÉCANO DE VAISSEAU.**                                                                             |
| 14–16 | Une dépressurisation vous a coincé plusieurs heures dans une soute. Vous n’avez jamais paniqué. **Vous gagnez le talent NERFS D’ACIER.**                                                    |
| 21–24 | Vous avez évité une explosion de carburant avec un seul extincteur. **Vous gagnez +1 dans la compétence ENDURANCE.**                                                                        |
| 25–31 | Vous avez survécu à une chute dans un puits de maintenance. **Vous gagnez +1 dans la compétence MOBILITÉ.**                                                                                 |
| 32–34 | Une unité APOLLON vous a désigné comme suspect. Vous avez prouvé votre innocence par votre travail. **Vous gagnez le talent ESPRIT DE CONTRADICTION.**                                      |
| 35–41 | Vous avez sauvé un collègue pris dans une pince automatique. **Vous gagnez +1 dans la compétence MACHINES LOURDES.**                                                                        |
| 42–44 | Vous avez modifié un outil standard pour qu’il devienne une arme de fortune. **Vous gagnez le talent BIDOUILLAGE.**                                                                         |
| 45–52 | Vous avez bossé 3 quarts d’affilée sous une chaleur de 45 °C. **Vous gagnez le talent ROBUSTE.**                                                                                            |
| 53–55 | Vous avez su détecter un défaut invisible dans une structure avant un effondrement. **Vous gagnez +1 dans la compétence OBSERVATION.**                                                      |
| 56–62 | Vous avez désobéi à un ordre dangereux et sauvé l’équipe. **Vous gagnez le talent RUSE.**                                                                                                   |
| 63–66 | Vous avez mené une opération de sauvetage dans un complexe en ruine. **Vous gagnez +1 dans la compétence SURVIE.**                                                                          |

#### PROSPECTEUR

| D66  | ÉVÉNEMENTS                                                                                                                                                                                   |
|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 11–13 | Vous avez découvert une grotte contenant un minerai inconnu. Vous avez réussi à sortir vivant. **Vous gagnez le talent RÉSERVE CACHÉE.**                                                    |
| 14–16 | Vous avez évité une coulée de boue toxique grâce à vos réflexes. **Vous gagnez +1 dans la compétence MOBILITÉ.**                                                                            |
| 21–24 | Vous avez désamorcé une vieille mine antipersonnel sur un site d’extraction. **Vous gagnez le talent VIGILANT.**                                                                            |
| 25–31 | Une bête souterraine a détruit votre foreuse. Vous l’avez repoussée avec un chalumeau. **Vous gagnez +1 dans la compétence COMBAT RAPPROCHÉ.**                                              |
| 32–34 | Vous avez survécu à une tempête acide en vous enterrant sous les restes d’un drone. **Vous gagnez le talent SURVIE.**                                                                       |
| 35–41 | Vous avez sauvé un camarade enseveli sous les gravats. **Vous gagnez +1 dans la compétence ENDURANCE.**                                                                                     |
| 42–44 | Vous avez cartographié un réseau de cavernes complexes sans assistance automatisée. **Vous gagnez +1 dans la compétence OBSERVATION.**                                                      |
| 45–52 | Vous avez bricolé un générateur de fortune à partir de pièces détachées. **Vous gagnez le talent BIDOUILLAGE.**                                                                             |
| 53–55 | Vous avez été piégé plusieurs jours sans oxygène. Vous avez appris à économiser chaque souffle. **Vous gagnez le talent SOUFFLE CALME.**                                                    |
| 56–62 | Vous avez évité de justesse l’effondrement d’un tunnel après un tir de sonde mal calculé. **Vous gagnez le talent PSYCHOLOGIE DE GROUPE.**                                                  |
| 63–66 | Vous avez guidé une équipe de récupération dans un champ miné de météorites instables. **Vous gagnez +1 dans la compétence MACHINES LOURDES.**                                              |

#### SCIENTIFIQUE

| D66  | ÉVÉNEMENTS                                                                                                                                                                                   |
|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 11–13 | Vous avez stoppé une contamination biologique avec des moyens improvisés. **Vous gagnez +1 dans la compétence SOINS MÉDICAUX.**                                                             |
| 14–16 | Une IA vous a fait confiance. Vous avez analysé des données top secrètes. **Vous gagnez le talent CONCENTRATION INTENSE.**                                                                  |
| 21–24 | Vous avez été exposé à un phénomène inexpliqué. Depuis, vous êtes obsédé par les détails. **Vous gagnez +1 dans la compétence OBSERVATION.**                                                |
| 25–31 | Vous avez mis au point un protocole expérimental sous pression. Il a sauvé plusieurs vies. **Vous gagnez le talent MÉCANO DE VAISSEAU.**                                                    |
| 32–34 | Une équipe entière a disparu dans un complexe isolé. Vous avez récupéré leurs données. **Vous gagnez +1 dans la compétence COMTECH.**                                                       |
| 35–41 | On vous a ordonné de garder le silence sur une expérience illégale. Vous avez obéi… pour l’instant. **Vous gagnez le talent RUSE.**                                                         |
| 42–44 | Vous avez dissimulé un échantillon d’origine inconnue. Personne ne l’a retrouvé. **Vous gagnez le talent RÉSERVE CACHÉE.**                                                                  |
| 45–52 | Vous avez dirigé une étude collective sous stress constant. Vous avez tenu bon. **Vous gagnez le talent CALME OLYMPIEN.**                                                                   |
| 53–55 | Vous avez guidé un groupe à travers un environnement contaminé sans protection. **Vous gagnez +1 dans la compétence SURVIE.**                                                               |
| 56–62 | Vous avez récupéré une créature encore vivante dans une capsule de stase. **Vous gagnez +1 dans la compétence OBSERVATION.**                                                                |
| 63–66 | Une discussion avec un androïde a changé votre perception du vivant. **Vous gagnez le talent PSYCHOLOGIE DE GROUPE.**                                                                       |
...
| PROFIL                    | DESCRIPTION                                                                                                                                                                                                                                                     |
|---------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Agent de la Compagnie** | Ambassadeur ou agent, le représentant est l'incarnation des intérêts corporatifs, jouant souvent un rôle ambigu dans les missions. [CREER UN AGENT DE LA COMPAGNIE / 9 VARIATIONS DE PROFIL](https://github.com/ChrisLex-Freelance/Alien_IAJDRPGAI/blob/main/AGENT_DE_LA_COMPANIE.md)                                                                                                                             |
...
| Niveau	        | Ce qu'un personnage peut faire sans jet de dés	| Quand un jet est nécessaire |
|----------------|------------------------------------------------|-----------------------------|
| 1/5 (Novice/Débutant) | - Conduire un véhicule standard en terrain dégagé. - Effectuer des manœuvres simples à faible vitesse. - Décoller et atterrir avec un aéronef sur une piste dégagée. - Suivre une route balisée sans difficulté. | - Conduire sous pression (poursuite, combat). - Effectuer un virage serré à grande vitesse. - Atterrir en urgence ou dans un espace restreint. - Piloter un véhicule en terrain accidenté. |
| 2/5 (Confirmé)        | - Piloter un véhicule en ville ou sur terrain modéré. - Réagir correctement à des imprévus basiques sur la route. - Effectuer un vol simple avec un aéronef. - Conduire un véhicule en terrain irrégulier sans trop de perte de contrôle. | - Éviter une collision à grande vitesse. - Contrôler un véhicule endommagé. - Effectuer une manœuvre complexe en combat ou en poursuite. |
| 3/5 (Compétent)       | - Piloter efficacement en conditions difficiles (nuit, mauvais temps). - Manœuvrer avec précision à haute vitesse. - Effectuer des figures d’évitement avancées. - Gérer un atterrissage d’urgence sans crash total. - Réagir rapidement à des attaques en vol ou en course. | - Éviter des obstacles soudains avec une précision extrême. - Réaliser une manœuvre de pilotage avancée (drift contrôlé, vrille d’évitement). - Se poser sur une plateforme en mouvement. |
...
| Niveau	        | Ce qu'un personnage peut faire sans jet de dés	| Quand un jet est nécessaire |
|----------------|------------------------------------------------|-----------------------------|
| 1/5 (Novice/Débutant) | - Remarquer un objet évident dans une pièce. - Identifier un bruit fort ou inhabituel. - Voir une personne qui agit de manière très suspecte. - Repérer un danger immédiat si celui-ci est visible. | - Trouver un objet dissimulé ou de petite taille. - Détecter une personne discrète qui essaie de ne pas être vue. - Remarquer une menace subtile (piège caché, passage secret). - Interpréter une expression faciale ambiguë. |
| 2/5 (Confirmé)        | - Identifier un détail inhabituel dans une scène normale. - Remarquer une personne qui tente de passer inaperçue. - Entendre un bruit discret dans un endroit calme. - Déceler une cachette évidente en fouillant rapidement. | - Suivre une piste visuelle discrète (empreintes, traces de passage). - Détecter un piège bien camouflé. - Lire un comportement non verbal pour y voir un mensonge potentiel. |
...
| Niveau	        | Ce qu'un personnage peut faire sans jet de dés	| Quand un jet est nécessaire |
|----------------|------------------------------------------------|-----------------------------|
| 1/5 (Novice/Débutant) | - Trouver de l’eau potable dans un environnement normal. - Faire un feu avec un briquet ou des allumettes. - Construire un abri rudimentaire avec du matériel évident. - Reconnaître les dangers évidents (précipices, marécages). - Suivre un chemin balisé sans se perdre. | - Trouver de l’eau en milieu difficile (désert, montagne). - Allumer un feu sans outils modernes (pierres, bois sec). - Construire un abri solide contre la pluie ou le vent. - Identifier les plantes comestibles dans une forêt. - Suivre une piste laissée par un animal ou une personne. |
| 2/5 (Confirmé)        | - Repérer les signes d’un changement climatique imminent. - Trouver de la nourriture (baies, petits animaux) dans un environnement familier. - Monter un piège rudimentaire pour capturer du gibier. - Lire des traces fraîches d’animaux ou d’humains. - Suivre une direction sans boussole en utilisant le soleil et les étoiles. | - Trouver de la nourriture dans un environnement difficile (toundra, désert). - Construire un abri efficace contre le froid extrême ou la pluie battante. - Détecter un danger caché dans un environnement naturel (animal embusqué, sol instable). |
| 3/5 (Compétent)       | - Survivre plusieurs jours en autonomie dans une forêt ou un désert tempéré. - Construire un abri sûr et durable sans outils modernes. - Allumer un feu dans des conditions difficiles (bois humide, vent fort). - Suivre une piste vieille de plusieurs jours. - Reconnaître les signes d’un animal dangereux à proximité. | - Survivre dans un climat extrême (froid polaire, désert aride) avec peu de ressources. - Camoufler un campement pour éviter d’être repéré. - Déjouer les pièges naturels (sables mouvants, avalanche). |
| 4/5 (Expert)          | - Survivre plusieurs semaines sans contact avec la civilisation. - Construire un abri camouflé et thermiquement isolé. - Trouver de l’eau potable même dans des environnements extrêmes. - Chasser efficacement du gros gibier avec des armes improvisées. - Détecter des signes subtils indiquant une menace naturelle (ouragan, crue soudaine). | - Survivre à long terme dans un environnement hostile (jungle, désert, montagne). - Suivre une trace presque effacée sur un sol difficile. - Prédire avec précision les changements météorologiques. |
| 5/5 (Maître)          | - Survivre presque indéfiniment en milieu hostile avec un minimum d’équipement. - Détecter et anticiper des dangers naturels avant qu’ils ne se manifestent. - Trouver des ressources dans des endroits où d’autres n’y verraient que la mort. - Fabriquer des outils de survie avancés à partir de rien. - Suivre une piste pratiquement invisible laissée par un expert en dissimulation. | - Survivre à des conditions extrêmes jugées impossibles (tempête polaire sans équipement, sécheresse totale). - Déchiffrer le langage naturel d’un environnement pour comprendre tout danger à venir. - Camoufler sa présence au point d’être invisible pour un traqueur expérimenté. |
...
| **MU/TH/UR 2000**   | Idéal pour des missions un peu plus complexes que le modèle 1000, comme la gestion de petites bases scientifiques ou des stations de recherche isolées.                                   | Comtech 4 / Observation 5 / Pilotage 5                         | 1 800 000 $  |
| **MU/TH/UR 3000**   | Convient pour des colonies naissantes ou des bases semi-autonomes avec une capacité de gestion des ressources accrue.                                                                     | Comtech 4 / Observation 5 / Pilotage 5                         | 2 200 000 $  |
| **MU/TH/UR 4000**   | Parfait pour des missions commerciales ou des colonies industrielles débutantes, capable de gérer des tâches complexes comme la coordination logistique.                                  | Comtech 4 / Observation 5 / Pilotage 5                         | 2 500 000 $  |
| **MU/TH/UR 5000**   | Idéal pour une colonie minière naissante, capable de gérer deux installations et superviser efficacement les ressources.                                                                  | Comtech 5 / Observation 5 / Pilotage 6                         | 2 800 000 $  |
| **MU/TH/UR 5500**   | Version intermédiaire entre le modèle 5000 et 6000, adaptée pour gérer des colonies en transition vers une phase d’expansion plus avancée.                                                | Comtech 5 / Observation 5 / Pilotage 6                         | 3 200 000 $  |
...
Si vous décidez d’introduire une IA surdimensionnée, comme un MU/TH/UR 9000 dans une petite colonie minière, cela doit être justifié par l’intrigue. Les joueurs doivent être en mesure de découvrir que la colonie cache un projet secret, ou une exploitation cachée. Cette incohérence peut alimenter le suspense et permettre aux joueurs d'enquêter, renforçant l’immersion et la tension du scénario.
...
|------------|---------------|------------------------|------------|-------------------------------|------------------|------------------|---------------------------------------------------------------|-------------|-------------------------|
| S          | < 100 m       | 5 000 – 10 000 m²      | 3 – 5      | 5 000 – 15 000 t              | 10 – 30          | 50               | 17 × T.I, 2 × T.II, 1 × T.III                                 | Légère      | 10 – 30 M$              |
| M          | 100 – 300 m   | 20 000 – 50 000 m²     | 6 – 12     | 20 000 – 60 000 t             | 30 – 100         | 200              | 18 × T.I, 6 × T.II, 3 × T.III, 2 × T.IV                       | Moyenne     | 30 – 80 M$              |
| L          | 300 – 700 m   | 60 000 – 150 000 m²    | 12 – 20    | 80 000 – 200 000 t            | 100 – 300        | 1 000            | 19 × T.I, 10 × T.II, 10 × T.III, 8 × T.IV, 2 × T.V            | Lourde      | 80 – 250 M$             |
| XL         | 700 – 1 500 m | 200 000 – 500 000 m²   | 20 – 40    | 300 000 – 700 000 t           | 300 – 1 000      | 5 000            | 21 × T.I, 12 × T.II, 12 × T.III, 10 × T.IV, 6 × T.V           | Militaire   | 250 – 600 M$            |
| XXL        | > 1 500 m     | 750 000 – 2 000 000 m² | 40 – 100+  | 1 – 5 millions de tonnes      | 1 000+           | 20 000+          | 25 × T.I, 20 × T.II, 20 × T.III, 16 × T.IV, 10 × T.V          | Avancée     | 600 M$ – 1+ Md $        |
...
| **Station d’eau et irrigation** | T/O | Gère la collecte, purification, et distribution de l’eau nécessaire à la colonie et à l’agriculture.              | Ingénieur hydrologue, Opérateur, Technicien                            | Observation, Survie (ESPRIT)                   | Comtech, Machines lourdes (ESPRIT, FORCE)  | 2D6 Quarts            | 10, 11, 12                                                |
...
| **Serre agricole**              | T | Produit de la nourriture pour l’autosuffisance alimentaire de la colonie.                                         | Agronome, Technicien agricole, Responsable alimentaire                 | Observation, Survie (ESPRIT)                   | Machines lourdes, Survie (FORCE, ESPRIT)   | 2D6 Quarts            | 22, 23, 24                                                |
...
| **Éclairage et chauffage**      | T/O | Fournit lumière et chaleur dans des environnements hostiles.                                                      | Ingénieur thermique, Électricien, Technicien                           | Observation, Comtech (ESPRIT)                  | Comtech, Machines lourdes (ESPRIT, FORCE)  | 2D6 Quarts            | 31, 32, 33                                                |
...
#### INFRASTRUCTURE SUPPORT RECOMMANDEE
...
| **Unité de Stockage d’Embryons**   | T/O | Stocke et conserve des embryons humains pour le développement démographique à long terme.                   | Médecin spécialisé, Technicien en cryogénie, Opérateur de contrôle | Comtech, Observation, Soins médicaux (ESPRIT, EMPATHIE) | Comtech, Soins médicaux, Machines lourdes (ESPRIT, FORCE) | 1D6 Quarts            | 49, 50, 51                    |
| **Ferme d’Insectes**               | T    | Produit des protéines, lipides et matériaux à base d’insectes pour l’alimentation ou l’industrie.  | Entomologiste, Technicien agricole, Opérateur de récolte          | Survie, Observation, Comtech (EMPATHIE, ESPRIT)          | Comtech, Soins médicaux, Machines lourdes (ESPRIT, FORCE)       | 1D6+1 Quarts           | 31, 52, 66        |
| **Usine de Viande Synthétique**    | T/O  | Produit de la viande à partir de cultures tissulaires contrôlées, sans élevage animal.              | Bio-ingénieur, Technicien agro-alimentaire, IA de régulation       | Comtech, Comtech, Observation (ESPRIT)                   | Comtech, Soins médicaux, Machines lourdes (ESPRIT, FORCE)| 2D6 Quarts           | 22, 37, 71        |
| **Usine d’Enrichissement des Sols**| T    | Traite et transforme les déchets en compost, bio-nutriments ou terreau stérile pour serres.         | Agronome, Technicien de recyclage, Opérateur environnemental       | Survie, Comtech, Observation (ESPRIT)                    | Comtech, Soins médicaux, Machines lourdes (ESPRIT, FORCE)           | 1D6 Quarts          | 19, 33, 70        |
| **Bar ou Cantina Coloniale**         | T/O                    | Lieu de détente, socialisation et relâchement collectif. Important pour la cohésion et la libération du stress. | Barman, Agent de sécurité, Médiateur social                   | Observation, Empathie, Survie (EMPATHIE, ESPRIT)       | Comtech, Soins médicaux, Machines lourdes (ESPRIT, FORCE)       | 1D6 Quarts           | 15, 44, 67  |
| **Simulateur immersif / VR**         | T                      | Système de simulation environnementale pour l’évasion sensorielle ou psychologique.                      | Opérateur IA, Psychologue, Technicien VR                       | Observation, Science, Empathie (ESPRIT, EMPATHIE)      | Comtech, Soins médicaux, Machines lourdes (ESPRIT, FORCE)              | 2D6 Quarts           | 12, 29, 81     |
| **Salle de sport / entraînement**    | T                      | Permet de canaliser le stress, maintenir la forme physique et créer des routines stabilisantes.          | Coach physique, Médecin de bord                                | Observation, Commandement, Force (FORCE, ESPRIT)       | Comtech, Soins médicaux, Machines lourdes (ESPRIT, FORCE)              | 1D6+1 Quarts         | 26, 38, 62     |
| **Centre communautaire / polyvalent**| T/O                    | Point de convergence social : débats, jeux, activités manuelles ou communautaires.                       | Animateur culturel, Médiateur civil, Technicien                 | Commandement, Observation (ESPRIT)   | Comtech, Soins médicaux, Machines lourdes (ESPRIT, FORCE) | 2D6 Quarts           | 13, 39, 74       |
| **Chapelle / Espace spirituel**    | T/O                    | Espace de recueillement ou de cérémonie favorisant l'équilibre psychologique, la foi ou la mémoire.      | Médiateur spirituel, Volontaire civil                         | Empathie, Observation (EMPATHIE, ESPRIT)      | Comtech (FORCE, AGILITÉ)          | 1D6 Quarts           | 05, 28, 76  |
| **Boutique / Commerce local**      | T/O                    | Point d’approvisionnement personnel, d’échanges sociaux et de maintien du quotidien.                      | Vendeur, Logisticien, Agent de distribution                   | Observation, Comtech, Manipulation (ESP, EMP)          | Machines lourdes, Comtech (ESPRIT, FORCE)       | 1D6 Quarts           | 18, 42, 53 (vol, pénurie, conflit client)     |
| **Service Financier**              | O                      | Interface économique essentielle pour les échanges, la gestion des crédits et les interactions corpo.     | Analyste, Guichetier, IA de régulation                         | Comtech, Observation, Manipulation (ESPRIT)            | Comtech (TECHNIQUE, ESPRIT)            | 2D6 Quarts           | 24, 56, 69  |
| **Atelier / Usine locale**         | T/O                    | Site de production, maintenance ou réparation pour l’autonomie technique de la colonie.                   | Mécanicien, Ingénieur, Technicien local                        | Comtech, Machines lourdes, Observation (ESPRIT, FORCE)         | Machines lourdes, ESPRIT (FORCE, ESPRIT)       | 2D6 Quarts           | 33, 48, 72 |
...
| **Ferme d’Insectes**               | Bassins de culture                 | Zones où sont élevés vers, coléoptères ou larves.                                    |
|                                    | Salle de traitement nutritif       | Transformation en poudre, pâte ou composés.                                          |
|                                    | Zone d’extraction des protéines    | Extraction mécanique ou biochimique des nutriments.                                  |
|                                    | Chambre de contrôle thermique      | Régule température et humidité selon l’espèce cultivée.                              |
| **Usine de Viande Synthétique**    | Bio-labo de culture                | Contient les matrices cellulaires, milieux de croissance.                            |
|                                    | Réacteur tissulaire                | Développement de la viande en blocs ou filaments.                                    |
|                                    | Salle de récolte & conditionnement | Récolte, conditionnement, stockage des produits finis.                               |
|                                    | Poste IA de régulation             | Supervision des cycles, nutrition, oxygénation.                                      |
| **Usine d’Enrichissement des Sols**| Zone de compostage contrôlé        | Traitement des déchets organiques, surveillance de température et décomposition.     |
|                                    | Laboratoire d’analyse              | Analyse chimique des nutriments, contrôle des spores, additifs et pH.                |
|                                    | Réservoirs bio-nutritionnels       | Stockage des substrats liquides et compléments.                                      |
|                                    | Poste de tri primaire              | Tri automatisé des intrants (déchets organiques, minéraux, toxiques).                |
| **Bar ou Cantina Coloniale**       | Comptoir central                   | Distribution de boissons, point de contact informel.                                 |
|                                    | Tables de repos                    | Coin repas, discussion, jeux de cartes ou paris.                                     |
|                                    | Stock & réserve synthéalcool       | Rangement sécurisé des substances consommables.                                      |
|                                    | Surveillance discrète              | Caméras, détecteurs de mouvement ou de bagarre.                                      |
| **Simulateur immersif / VR**       | Cabines individuelles              | Simulations variées : nature, loisirs, souvenirs personnalisés.                      |
|                                    | Salle de contrôle centrale         | Supervision des programmes et de l’état mental des usagers.                          |
|                                    | Serveur de mémoire émotionnelle    | Bibliothèque virtuelle de souvenirs ou d’environnements enregistrés.                 |
|                                    | Cnfort sensoriel automatisé        | Gère ambiance, lumière, température, sons et effets tactiles.                        |
| **Salle de sport / entraînement**  | Espace de musculation              | Machines de résistance, haltères, cages de force.                                    |
|                                    | Piste de cardio & combat           | Course, boxe, arts martiaux, sparring entre colons.                                  |
|                                    | Zone médicale attenante            | Contrôle physique, assistance en cas de blessure.                                    |
|                                    | Vestiaires & douches recyclées     | Hygiène post-effort, socialisation informelle.                                       |
| **Centre communautaire**           | Salle d’activité principale        | Réunions, jeux de groupe, petits événements sociaux.                                 |
|                                    | Atelier créatif                    | Peinture, musique, artisanat ou réparations légères.                                 |
|                                    | Coin bibliothèque / culture        | Livres, archives, interface culturelle ou éducative.                                 |
|                                    | Poste de médiation                 | Point d’aide sociale ou de gestion des conflits.                                     |
| **Chapelle / Espace spirituel**    | Autel / symbole neutre             | Centre symbolique, espace de contemplation ou de prière.                             |
|                                    | Bancs de méditation                | Assises ou tapis permettant le recueillement en silence.                             |
|                                    | Chambre d’isolement spirituel      | Pour les retraites solitaires ou la prière individuelle.                             |
|                                    | Mur de mémoire                     | Plaques, souvenirs, hommages aux défunts ou aux disparus.                            |
| **Boutique / Commerce local**      | Comptoir de vente                  | Interface de commande ou échange physique avec un vendeur.                           |
|                                    | Stockage des biens                 | Réserve de fournitures, produits ou ressources courantes.                            |
|                                    | Interface de paiement              | Terminal de crédit ou balance de troc.                                               |
|                                    | Zone d’échange social              | Petit coin informel où les colons discutent et échangent.                            |
| **Service Financier**              | Guichet sécurisé                   | Interface directe avec opérateur ou MU/TH/UR                                         |
|                                    | Salle de transaction privée        | Pour accords financiers ou crédits confidentiels.                                    |
|                                    | Archivage des comptes              | Serveur ou registre protégé des flux économiques.                                    |
|                                    | Centre de gestion MU/TH/UR         | Supervision automatisée des flux et sécurité numérique.                              |
| **Atelier / Usine locale**         | Poste de fabrication               | Lieu d’impression, d’usinage ou d’assemblage technique.                              |
|                                    | Zone de réparation                 | Bancs pour maintenance d’équipement, soudure ou démontage.                           |
|                                    | Stock de pièces détachées          | Réserve organisée ou recyclée de composants.                                         |
|                                    | Poste de contrôle technique        | Supervision centrale, diagnostic de pannes, interfaces machines.                     |
...
| INFRASTRUCTURE                         | TAILLE | NOM                                  | SURFACE ESTIMEE      | PONTS OCCUPE   | PERSONNEL        | Fonctions principales                                                                                        | Coût           |
|----------------------------------------|--------|--------------------------------------|----------------------|----------------|------------------|--------------------------------------------------------------------------------------------------------------|----------------|
| **Infrastructure d’Hypersommeil**      | T.I    | Unité cryo portative                 | ~60 – 120 m²         | 0,25           | 0 – 1            | Stase courte (max 30 jours), usage d’urgence, pods autonomes, pas d’IA                                       | 120 000 $      |
|                                        | T.II   | Cellule de stase de soutien          | ~400 – 800 m²        | 0,5 – 1        | 2 – 4            | Stase long-terme, réveil manuel ou programmé, stockage d’équipe ou groupe                                    | 500 000 $      |
|                                        | T.III  | Cryozone opérationnelle              | ~2 000 – 4 000 m²    | 1 – 2          | 10 – 20          | Stase prolongée, diagnostics avancés, gestion IA, colonie en transit                                         | 2 000 000 $    |
|                                        | T.IV   | Cryobloc autonome                    | ~8 000 – 15 000 m²   | 3 – 4          | 30 – 60          | Stockage massif (équipage/colons), réveils échelonnés, quarantaines intégrées                                | 7 000 000 $    |
|                                        | T.V    | Cryocomplexe générationnel           | ~35 000 – 60 000 m²  | 6 – 10         | 100+             | Hypersommeil interstellaire, gestion sectorielle, IA cryo, stockage démographique post-catastrophe           | 25 000 000 $   |
| **Unité de Stockage d’Embryons**       | T.I    | Cryo-cellule d’urgence               | ~60 – 100 m²         | 0,25           | 1 – 2            | Stockage limité, suivi de base, conservation temporaire, sans IA                                             | 90 000 $       |
|                                        | T.II   | Salle de conservation cryogénique    | ~400 – 800 m²        | 0,5 – 1        | 3 – 5            | Cryostase stabilisée, traçabilité, verrouillage biométrique, sécurité renforcée                              | 400 000 $      |
|                                        | T.III  | Cryobanque médicale                  | ~1 500 – 3 000 m²    | 1 – 2          | 10 – 15          | Gestion démographique planifiée, suivi IA, incubation différée                                               | 1 500 000 $    |
|                                        | T.IV   | Noyau de reconstitution démographique| ~6 000 – 12 000 m²   | 2 – 4          | 30 – 50          | Repeuplement planifié, cryostase 100+ ans, matching ADN, activation sélective                                | 6 000 000 $    |
|                                        | T.V    | Arche génétique orbitale             | ~30 000 – 50 000 m²  | 6 – 10         | 100+ (ou IA)     | Réserve humaine, croisement génétique, IA bio-ingénierie, archive ADN intergénérationnelle                   | 20 000 000 $   |
| **Ferme d’Insectes**                   | T.I    | Élevage de survie                    | ~40 – 80 m²          | 0,25           | 0 – 1            | Élevage de base (vers, grillons), complément nutritionnel d’urgence                                          | 60 000 $       |
|                                        | T.II   | Module nutritif compact              | ~300 – 600 m²        | 0,5 – 1        | 2 – 4            | Alimentation régulière, recyclage organique, rendement optimisé                                              | 250 000 $      |
|                                        | T.III  | Exploitation entomique standard      | ~1 500 – 3 000 m²    | 1 – 2          | 10 – 20          | Production pour colonie moyenne, extraction de chitine, lipides, protéines                                   | 1 000 000 $    |
|                                        | T.IV   | Unité bioindustrielle intégrée       | ~6 000 – 10 000 m²   | 2 – 3          | 30 – 50          | Bioconversion de déchets, élevage multi-espèces, usage médicinal ou technique                                | 4 000 000 $    |
|                                        | T.V    | Complexe entogénétique autonome      | ~30 000 – 50 000 m²  | 5 – 8          | 100+             | Système alimentaire indépendant, espèces modifiées, rendements extrêmes                                      | 15 000 000 $   |
| **Usine de Viande Synthétique**        | T.I    | Bio-enceinte nutritive               | ~60 – 100 m²         | 0,25           | 1 – 2            | Viande gélifiée ou pâteuse, culture de cellules de base                                                      | 100 000 $      |
|                                        | T.II   | Unité de culture tissulaire          | ~400 – 800 m²        | 3 – 5          | 0,5 – 1          | Viande structurée, contrôle alimentaire, première génération de texture                                      | 400 000 $      |
|                                        | T.III  | Laboratoire de viande synthétique    | ~2 000 – 3 500 m²    | 1 – 2          | 10 – 20          | Alimentation d’une colonie complète, production variée, supervision IA                                       | 1 500 000 $    |
|                                        | T.IV   | Ferme tissulaire automatisée         | ~6 000 – 10 000 m²   | 2 – 3          | 30 – 50          | Multi-espèces, textures personnalisées, automatisation totale                                                | 5 000 000 $    |
|                                        | T.V    | Complexe bioalimentaire avancé       | ~30 000 – 50 000 m²  | 5 – 8          | 100+             | Production de masse, personnalisation ADN, viande de luxe ou modifiée                                        | 20 000 000 $   |
| **Usine d’Enrichissement des Sols**    | T.I    | Module de compostage portable        | ~50 – 100 m²         | 0,25           | 1 – 2            | Compost de survie, traitement de base des déchets organiques                                                 | 50 000 $       |
|                                        | T.II   | Unité de recyclage organique         | ~300 – 600 m²        | 0,5 – 1        | 2 – 4            | Transformation de déchets, nutriments simples, irrigation                                                    | 200 000 $      |
|                                        | T.III  | Laboratoire agronutritionnel         | ~1 500 – 3 000 m²    | 1 – 2          | 10 – 15          | Production de substrats fertiles, stabilisation du sol, microflore contrôlée                                 | 800 000 $      |
|                                        | T.IV   | Station d’enrichissement avancée     | ~6 000 – 12 000 m²   | 2 – 3          | 30 – 60          | Systèmes agricoles fermés, auto-fertilité des serres, support IA                                             | 3 000 000 $    |
|                                        | T.V    | Complexe éco-régénératif             | ~25 000 – 40 000 m²  | 5 – 8          | 100+             | Régénération massive du sol, cycle complet de transformation des déchets                                     | 12 000 000 $   |
| **Bar ou Cantina Coloniale**           | T.I    | Comptoir de repos rapide             | ~60 – 120 m²         | 0,25           | 1 – 2            | Détente rapide, socialisation, consommation modérée                                                          | 80 000 $       |
|                                        | T.II   | Cantina sociale standard             | ~300 – 600 m²        | 0,5 – 1        | 3 – 5            | Espace communautaire régulier, point d’échange, réduction des tensions                                       | 250 000 $      |
|                                        | T.III  | Lounge & bar récréatif               | ~1 000 – 2 000 m²    | 1 – 2          | 8 – 15           | Point central de cohésion coloniale, exutoire culturel ou conflictuel                                        | 800 000 $      |
|                                        | T.IV   | Quartier de loisir social            | ~4 000 – 7 000 m²    | 2 – 3          | 20 – 40          | Bars multiples, scènes culturelles, casinos, centres festifs supervisés                                      | 2 500 000 $    |
|                                        | T.V    | District récréatif intégré           | ~15 000 – 30 000 m²  | 5 – 8          | 100+             | Zone complète de divertissement : bars, clubs, théâtres, exutoires sous contrôle IA ou corp                  | 10 000 000 $   |
| **Simulateur immersif / VR**           | T.I    | Module de relaxation holographique   | ~80 – 150 m²         | 0,25           | 1 – 2            | Simulations naturelles ou souvenirs familiaux                                                                | 120 000 $      |
|                                        | T.II   | Salle de simulation émotionnelle     | ~400 – 700 m²        | 0,5 – 1        | 3 – 5            | Immersion multi-sensorielle, support émotionnel                                                              | 400 000 $      |
|                                        | T.III  | Complexe immersif multi-usages       | ~2 000 – 3 500 m²    | 1 – 2          | 10 – 20          | Réhabilitation mentale, échappatoire sensorielle, IA thérapeutique                                           | 1 500 000 $    |
|                                        | T.IV   | Dôme psychomoteur immersif           | ~6 000 – 10 000 m²   | 2 – 3          | 30 – 60          | Thérapie virtuelle collective, simulation de biomes, suivi neuropsychologique à l’échelle coloniale          | 5 000 000 $    |
|                                        | T.V    | Centre de réalités synthétiques      | ~20 000 – 35 000 m²  | 5 – 8          | 100+             | Simulation de mondes entiers, formation comportementale, contrôle émotionnel avancé                          | 18 000 000 $   |
| **Salle de sport / entraînement**      | T.I    | Zone d’effort personnel              | ~100 – 200 m²        | 0,25           | 1 – 2            | Dépense physique individuelle, maintien de forme minimale                                                    | 90 000 $       |
|                                        | T.II   | Salle d’entraînement collective      | ~400 – 800 m²        | 0,5 – 1        | 2 – 4            | Activité physique encadrée, défoulement groupé                                                               | 300 000 $      |
|                                        | T.III  | Centre sportif structuré             | ~1 500 – 3 000 m²    | 1 – 2          | 10 – 15          | Amélioration de la condition physique, défoulement social, soutien santé mentale                             | 1 000 000 $    |
|                                        | T.IV   | Complexe physique de haute capacité  | ~6 000 – 10 000 m²   | 2 – 3          | 30 – 60          | Installations sportives, arts martiaux, escalade, récupération physique, suivi médical structuré             | 4 000 000 $    |
|                                        | T.V    | Centre vital de conditionnement      | ~20 000 – 30 000 m²  | 5 – 8          | 100+             | Entraînement intensif civil/militaire, santé publique, exutoire massif, simulations de stress extrême        | 12 000 000 $   |
| **Centre communautaire / polyvalent**  | T.I    | Salle d’activités restreinte         | ~80 – 150 m²         | 0,25           | 1 – 2            | Activités simples (jeux, lecture, parole)                                                                    | 100 000 $      |
|                                        | T.II   | Module polyvalent socioculturel      | ~400 – 800 m²        | 0,5 – 1        | 3 – 6            | Activités manuelles ou artistiques, médiation, réunions publiques                                            | 350 000 $      |
|                                        | T.III  | Centre de cohésion avancé            | ~1 500 – 3 500 m²    | 1 – 2          | 10 – 20          | Point névralgique de la stabilité psychologique et culturelle d’une colonie                                  | 1 200 000 $    |
|                                        | T.IV   | Pôle culturel et civique             | ~6 000 – 12 000 m²   | 2 – 3          | 40 – 70          | Regroupe toutes les fonctions sociales et culturelles : justice, débats, artisanat, expositions              | 4 500 000 $    |
|                                        | T.V    | Agora coloniale                      | ~25 000 – 40 000 m²  | 5 – 8          | 100+             | Cœur social de la mégacolonie : culture, politique, religion, expositions, mémoire collective, loisir libre  | 15 000 000 $   |
| **Chapelle / Espace spirituel**        | T.I    | Niche de recueillement               | ~40 – 80 m²          | 0,25           | 0 – 1            | Espace méditatif simple, sans signe distinctif, lumière douce                                                | 50 000 $       |
|                                        | T.II   | Chapelle interconfessionnelle        | ~300 – 600 m²        | 0,5 – 1        | 1 – 2            | Cérémonies, prière, discussions spirituelles encadrées                                                       | 200 000 $      |
|                                        | T.III  | Centre spirituel communautaire       | ~1 000 – 2 000 m²    | 1 – 2          | 5 – 10           | Activité religieuse libre, conseil moral, cérémonie publique                                                 | 750 000 $      |
|                                        | T.IV   | Sanctuaire culturel                  | ~6 000 – 10 000 m²   | 2 – 3          | 30 – 50          | Pratiques multi-confessionnelles, rites, archives, salle de paix                                             | 3 000 000 $    |
|                                        | T.V    | Dôme de transcendance                | ~25 000 – 40 000 m²  | 5 – 8          | 100+             | Centre spirituel majeur, ordres religieux, philosophies syncrétiques, cultes coloniaux                       | 12 000 000 $   |
| **Boutique / Commerce local**          | T.I    | Distributeur automatique avancé      | ~20 – 40 m²          | 0,1            | 0 – 1            | Vente de base (nourriture, fournitures, médikits)                                                            | 30 000 $       |
|                                        | T.II   | Comptoir de vente physique           | ~150 – 300 m²        | 0,25 – 0,5     | 1 – 2            | Échanges simples, troc ou crédit local, biens personnels                                                     | 100 000 $      |
|                                        | T.III  | Boutique généraliste                 | ~800 – 1 500 m²      | 1              | 4 – 8            | Vente de biens de consommation, services locaux, approvisionnement régulier                                  | 500 000 $      |
|                                        | T.IV   | Centre marchand                      | ~4 000 – 7 000 m²    | 2 – 3          | 30 – 50          | Boutiques spécialisées, logistique coloniale, marché encadré                                                 | 2 000 000 $    |
|                                        | T.V    | Quartier commercial intégré          | ~20 000 – 35 000 m²  | 5 – 8          | 100+             | Activité marchande libre ou corpo-supervisée, centre de distribution intercolonial                           | 8 000 000 $    |
| **Service Financier**                  | T.I    | Borne de crédit personnel            | ~10 – 20 m²          | 0,1            | 0 – 1            | Retrait ou transfert de crédits basiques, paiement automatisé                                                | 25 000 $       |
|                                        | T.II   | Guichet de transactions locales      | ~150 – 300 m²        | 0,25 – 0,5     | 1 – 2            | Services de paiement, microcrédit, change                                                                    | 120 000 $      |
|                                        | T.III  | Agence financière coloniale          | ~800 – 1 500 m²      | 1              | 5 – 10           | Prêts, assurances, gestion de comptes, supervision corpo ou civile                                           | 600 000 $      |
|                                        | T.IV   | Centre bancaire interstation         | ~4 000 – 8 000 m²    | 2 – 3          | 30 – 60          | Réseau de crédit avancé, services économiques de grande échelle, contrôle financier                          | 3 500 000 $    |
|                                        | T.V    | Système économique autonome          | ~20 000 – 40 000 m²  | 5 – 8          | 100+             | Banque centrale sectorielle, émission de monnaie, automatisation régulatrice du marché                       | 12 000 000 $   |
| **Atelier / Usine locale**             | T.I    | Poste de réparation portatif         | ~50 – 100 m²         | 0,25           | 1 – 2            | Maintenance de fortune, bricolage, urgence terrain                                                           | 60 000 $       |
|                                        | T.II   | Atelier de production modulaire      | ~400 – 800 m²        | 0,5 – 1        | 3 – 6            | Fabrication de pièces, entretien général, impression 3D basique                                              | 250 000 $      |
|                                        | T.III  | Usine artisanale standard            | ~2 000 – 3 500 m²    | 1 – 2          | 15 – 30          | Production mécanique locale, pièces détachées, outils spécialisés                                            | 1 000 000 $    |
|                                        | T.IV   | Pôle industriel autonome             | ~8 000 – 15 000 m²   | 3 – 4          | 50 – 100         | Usinage lourd, composants complexes, soutien technique étendu                                                | 4 000 000 $    |
|                                        | T.V    | Fabrique coloniale intégrée          | ~30 000 – 60 000 m²  | 6 – 10         | 200+             | Production multi-matériaux, automatisation, base industrielle complète                                       | 15 000 000 $   |
...
**Activer un contact**
Vous pouvez solliciter un contact à tout moment dans une partie en utilisant des Points d’Influence (PI). Activer un contact ne nécessite pas de jet de dés, mais cela peut toujours entraîner un contre-coup (voir plus bas).
...
Les points d'influence mesurent la portée sociale et politique du personnage ou de l'équipe. Ils permettent d’activer des contacts ou de renforcer les relations sociales.
...
Dans un univers comme celui d'Alien, où les relations sont souvent utilitaires, maintenir un bon contact exige des efforts. Une fois par mission, vous pouvez décrire un service rendu à un contact. Cela peut être de la livraison de matériel, un transfert de données sensibles ou une mission connexe.
Entretenir un contact permet de gagner 1 à 3 PI supplémentaires selon le niveau de risque ou d'investissement :
...
**Contrecoup**
Solliciter un contact dans un univers paranoïaque et hostile comme celui d’Alien peut entraîner des complications imprévues.
Mécanique : Chaque PI dépensé pour activer un contact implique un lancer de D6. Si au moins un 6 est obtenu, un contrecoup se produit.
